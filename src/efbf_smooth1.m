%EFBF_SMOOTH  Extended Forward-Backward Filtering Based Smoother
%
% Syntax:
%   [M,P] = EFBF_SMOOTH(M,P,Y,A,Q,ia,W,aparam,H,R,h,V,hparam,same_p_a,same_p_h)
%
% In:
...
%
% $Id: efbf_smooth1.m,v 1.4 2006/09/29 13:43:32 ssarkka Exp $
%
...
function [M,P] = efbf_smooth1(M,P,Y,A,Q,ia,W,aparam,H,R,h,V,hparam,same_p_a,same_p_h)
