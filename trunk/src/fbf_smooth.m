%FBF_SMOOTH  Forward-Backward Filtering Based Smoother
%
% Syntax:
%   [M,P] = FBF_SMOOTH(M,P,Y,A,Q,H,R,[use_inf])
%
% In:
...
%     PP(:,:,k) = P;
%   end
%   [SM,SP] = fbs_smooth(MM,PP,A,Q,H,R,Y);
%
% History:
% 
...
function [M,P] = fbf_smooth(M,P,Y,A,Q,H,R,use_inf)
